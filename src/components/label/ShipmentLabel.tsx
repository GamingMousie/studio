  ...
  return (
    <div className="p-3 border border-foreground rounded-md shadow-sm w-full sm:w-[calc(50%-0.5rem)] md:w-[calc(33.333%-0.66rem)] lg:w-[calc(25%-0.75rem)] bg-background text-foreground print:shadow-none print:border-black print:w-[108mm] print:h-[150mm] print:p-1.5 print:break-words label-item flex flex-col justify-between">
      <div>
        ...
        <div className="space-y-1 print:my-px print:leading-normal"> {/* Removed print:space-y-2, changed print:leading-relaxed to print:leading-normal */}
          ...
          {shipment.customerJobNumber && (
            <p className="flex items-center print:text-[28pt] print:font-semibold print:mb-2"> {/* Changed from font-normal to font-semibold */}
      ...
      <div className="mt-2 pt-2 border-t border-dashed border-muted-foreground print:border-black print:mt-auto print:pt-2 print:mb-1"> {/* Ensure this section is pushed to bottom */}
