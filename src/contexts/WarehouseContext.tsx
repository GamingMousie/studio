...
const initialShipments: Shipment[] = [
  { id: uuidv4(), trailerId: 'T-001', stsJob: 12345, quantity: 50, importer: 'National Importers Ltd.', locationName: 'Location 11', releaseDocumentName: 'release_electronics_123.pdf', clearanceDocumentName: 'clearance_electronics_123.pdf', released: true, cleared: true, weight: 1200, palletSpace: 4 },
  { id: uuidv4(), trailerId: 'T-001', stsJob: 67890, quantity: 200, importer: 'Global Goods Inc.', locationName: 'Location 12', released: false, cleared: false, weight: 800, palletSpace: 6 },
  { id: uuidv4(), trailerId: 'T-002', stsJob: 11223, quantity: 10, importer: 'Cross-Border Traders', locationName: 'Location 13', releaseDocumentName: 'industrial_release.docx', released: true, cleared: false, weight: 2500, palletSpace: 2 },
  { id: uuidv4(), trailerId: 'T-003', stsJob: 22334, quantity: 75, importer: 'FoodStuffs Co.', locationName: 'Location 14', released: true, cleared: true, weight: 1500, palletSpace: 10 },
  { id: uuidv4(), trailerId: 'T-003', stsJob: 33445, quantity: 120, importer: 'Fashion Forward', locationName: 'Location 15', released: false, cleared: true, weight: 600, palletSpace: 8 },
  { id: uuidv4(), trailerId: 'T-004', stsJob: 44556, quantity: 30, importer: 'BuildIt Supplies', locationName: 'Location 16', released: true, cleared: false, weight: 5000, palletSpace: 5 },
  { id: uuidv4(), trailerId: 'T-001', stsJob: 55667, quantity: 90, importer: 'HealthCorp', locationName: 'Location 17', released: true, cleared: true, weight: 300, palletSpace: 3 },
  { id: uuidv4(), trailerId: 'T-002', stsJob: 66778, quantity: 150, importer: 'Mechanics United', locationName: 'Location 18', released: false, cleared: false, weight: 1800, palletSpace: 12 },
  { id: uuidv4(), trailerId: 'T-004', stsJob: 77889, quantity: 25, importer: 'Luxury Imports', locationName: 'Location 19', released: true, cleared: true, weight: 400, palletSpace: 2 },
