    ...
    <div className="p-3 border border-foreground rounded-md shadow-sm w-full sm:w-[calc(50%-0.5rem)] md:w-[calc(33.333%-0.66rem)] lg:w-[calc(25%-0.75rem)] bg-background text-foreground print:shadow-none print:border-black print:w-[108mm] print:h-[150mm] print:p-3 print:break-words label-item flex flex-col justify-between">
      <div>
        ...
        <div className="space-y-1 print:space-y-2 print:my-px text-[0.65rem] leading-normal print:leading-relaxed">
          ...
          <p className="flex items-center print:text-[40pt] print:font-bold print:mb-3"><Tag className="h-3 w-3 mr-1 print:hidden"/><strong>Pieces:</strong> <span className="ml-1">{shipment.quantity}</span></p>
          
          <p className="flex items-center print:text-[32pt] print:font-bold print:mb-3">
            <strong>Ref:</strong> 
          ...
          {shipment.customerJobNumber && (
            <p className="flex items-center print:text-[28pt] print:mb-2">
      ...
      <div className="mt-2 pt-2 border-t border-dashed border-muted-foreground print:border-black print:mt-3 print:pt-3 print:mb-1">
        ...
        <p className="text-center font-mono text-[0.55rem] print:text-[22pt] print:font-bold break-all mt-1 print:mt-2 leading-tight tracking-tighter" title={barcodeValue}>
          {barcodeValue}
        </p>
      </div>
    </div>
